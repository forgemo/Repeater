...
- The `Repeater` dynamically calculates, how long you may `delay()` your main loop between function calls to maximize your energy efficency. The Repeate will, of course, never use `delay()` internally.
